    ...
    public class ProyectoController : ApiController
    {
        ...
        public IHttpActionResult ProjectInfo(string id)
        {
            ...
            var queryProduct =
                ...
                "\r\nFROM " + dbName + ".\"JDT1\" T0" +
                "\r\nINNER JOIN " + dbName + ".\"OACT\" T1 " +
                "\r\n\tON T1.\"AcctCode\" = T0.\"Account\" " +
                "\r\n\tand T1.\"Budget\"='Y'" +
                "\r\nINNER JOIN " + dbName + ".\"OPRJ\" T7" +
